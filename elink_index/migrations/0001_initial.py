...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('long_link', models.TextField(max_length=5000, verbose_name='Длинная ссылка')),
                ...
                ('description', models.CharField(blank=True, max_length=1000, null=True, verbose_name='Имя/Описание')),
                ('limited_link', models.IntegerField(blank=True, default=-1, verbose_name='Лимит')),
