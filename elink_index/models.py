...
class LinkRegUser(models.Model):
    ...
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="owner_link", null=False
    )
    # Изначальная ссылка
    long_link = models.TextField(max_length=5000, null=False)
    ...
    how_many_clicked = models.IntegerField(default=0)
    # Повторные переходы
    again_how_many_clicked = models.IntegerField(default=0)
