...
#from django.contrib.auth.models.Group import Group
...
class UserAdmin(admin.ModelAdmin):
    ...
    list_display = ["email", "subs_type", "date_join", "banned", "my_timezone", "violations", "send_stat_email", "trust_rating"]
    fields = ["email", "subs_type", "link_count", "trust", "my_timezone", "violations", "send_stat_email", "trust_rating"]
    search_fields = ["email"]
