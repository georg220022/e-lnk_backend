...
##### Это лишь открытая часть проекта, полноценный код в приватном репозитории с доступом по запросу
...
3) ```Pytest```:  
> 3.1) Слезно обещаю написать тесты....)))  
...
### ВАЖНО! На сервере временно запустил проект без контейнеров, так как Dockerfile был не оптимизирован.
...
***  
#### О проекте:  
Сервис содержит более 3500 строк python кода, на разработку ушло около 4-х месяцев.
...
***
### Другие скриншоты:
![Locust](https://github.com/georg220022/e-lnk_backend/blob/main/images/2022-10-18_15-14.png)
***
