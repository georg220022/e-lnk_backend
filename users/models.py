...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    link_count = models.IntegerField(default=0,
                                     verbose_name='количество ссылок')
    subs_type = models.CharField(choices=CHOICES, max_length=50,
    ...
    trust = models.BooleanField(default=False,
                                verbose_name='доверенный пользователь')
    ...
    public_key = models.CharField(max_length=25, db_index=True,
                                  default=0000000000)
    trust_rating = models.IntegerField(default=100000,
